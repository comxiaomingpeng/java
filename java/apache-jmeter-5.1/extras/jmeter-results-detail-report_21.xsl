...
<xsl:template name="pageHeader">
	...
	<table width="100%">
		<tr>
			<td align="left">时间: <xsl:value-of select="$dateReport" /></td>
			<td align="right">设计用到了 <a href="http://jmeter.apache.org/">JMeter</a> 和 <a href="http://ant.apache.org">Ant</a>.</td>
		</tr>
	</table>
	<hr size="1" />
</xsl:template>
